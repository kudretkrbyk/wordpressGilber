  ...
  return (
    <div className="w-full h-screen relative">
      <div className="z-0 absolute top-0 left-0 w-full h-screen overflow-hidden">
        <div
          ref={imageRef}
          className={`bg-cover bg-center w-full h-screen bg-[url(http://paul-themes.com/wordpress/gilber/wp-content/uploads/2020/12/home.jpg)] transition-transform duration-[4000ms] ${scale}`}
        ></div>
      </div>
